...
import de.ventority.lprefixor.PrefixOperations.ColorModifiers;
...
public enum fadePermissionsWithItemStack {
    ...
    fadePermissionsWithItemStack(String name, ItemStack item, String permission, ChatColor c1, ChatColor c2) {
        ...
        assert meta != null;
        meta.setDisplayName(PrefixOperations.removeEnding(ColorModifiers.fadeBetweenColors(c1.getColor(), c2.getColor(), name)));
